 ...
 * Operations
 */
$GLOBALS['TL_LANG']['tl_php2xliff']['edit'] = ['Datensatz mit ID: %s bearbeiten', 'Datensatz mit ID: %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_php2xliff']['copy'] = ['Datensatz mit ID: %s kopieren', 'Datensatz mit ID: %s kopieren'];
$GLOBALS['TL_LANG']['tl_php2xliff']['delete'] = ['Datensatz mit ID: %s löschen', 'Datensatz mit ID: %s löschen'];
$GLOBALS['TL_LANG']['tl_php2xliff']['show'] = ['Datensatz mit ID: %s ansehen', 'Datensatz mit ID: %s ansehen'];

/*
 * Fields
 */
$GLOBALS['TL_LANG']['tl_php2xliff']['title'] = ['Titel', 'Geben Sie den Titel ein.'];
 ...
 * Operations
 */
$GLOBALS['TL_LANG']['tl_php2xliff']['convertphp2xliff'] = ['Konvertierung von PHP zu XLIFF mit ID: %s starten', 'Konvertierung von PHP zu XLIFF mit ID: %s starten'];
